  ...
  return (
    <div className="flex flex-col items-center p-8 space-y-12 min-h-screen bg-gradient-to-r from-blue-100 to-teal-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12 w-full max-w-7xl">
        ...
        />
        <div className="col-span-1 sm:col-span-2 lg:col-span-3 flex flex-col items-center bg-white rounded-lg shadow-lg p-6 transition-transform transform hover:scale-105 border border-gray-300 animate-slide-in">
